...
public class Test {
    public static void main(String[] args) {
        ...
        int gn=in.nextInt();
        myAuto1.setGosNom(gn);
        System.out.print("Введите максимальную скорость: ");
        int s=in.nextInt();
        myAuto1.setMaxSpeed(s);
        System.out.println("Какой-то автомобиль: "+myAuto1.getFirm()+" "+myAuto1.getGosNom()+" "+myAuto1.getMaxSpeed());
        System.out.println();
        Car myCar1=new Car("Ford", 200,456,"Mustang",2,false);
        Car myCar2=new Car();
